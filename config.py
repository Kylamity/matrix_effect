...
SAVE_ALL = True # if true, only the final output iteration will be saved
OUTPUT_DIR = "output" # supports relative path, path must exist

# Character Segments
SEED_STRING = "KYLAMITY|"
#SEED_STRING = "ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!@#$%&*()=+[]{};:<>/?"
RANDOMIZE_STRING = False # if true, segments will ignore seed string order
BASE_COLOR = [0, 138, 37] # [R, G, B] 0 - 255 (segment "body" color)
